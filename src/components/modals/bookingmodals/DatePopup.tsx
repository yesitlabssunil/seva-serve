        ...
        <>
            <div className="modal fade" id="select-date-time-popup" data-bs-backdrop="static" tabIndex={-1}
                ...
                <div className="modal-dialog">
                    ...
                    <label for="time-1"><i className="fa-regular fa-clock"></i> 11:00 AM - 1:00 PM</label>

                    <input type="radio" hidden id="time-2" name="time" value="2"/>
                    <label for="time-2"><i className="fa-regular fa-clock"></i> 11:00 AM - 1:00 PM</label>

                    <input type="radio" hidden id="time-3" name="time" value="3"/>
                    <label for="time-3"><i className="fa-regular fa-clock"></i> 11:00 AM - 1:00 PM</label>

                    <input type="radio" hidden id="time-4" name="time" value="4"/>
                    <label for="time-4"><i className="fa-regular fa-clock"></i> 11:00 AM - 1:00 PM</label>

                    <input type="radio" hidden id="time-5" name="time" value="5"/>
                    <label for="time-5"><i className="fa-regular fa-clock"></i> 11:00 AM - 1:00 PM</label>
                  </div> */}
                                            <div className="select-time-btn-grp">
                                                <input
                                                    type="radio"
                                                ...
                                                <label htmlFor="time-1">
                                                    <i className="fa-regular fa-clock"></i> 11:00 AM - 1:00 PM
                                                </label>
                                    ...
                                    <div className="select-date-time-foot">
                                        ...
                                        <button type="submit" className="filled" data-bs-dismiss="modal">
